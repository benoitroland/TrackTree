...
inputdataset="input_ZeroBias_ZB1_Run2015B_HFRereco_RECO.txt"
...
do
    ...
    pyfile="ZeroBias_ZB1_Run2015B_Prompt_v2_251721_38T_HFRereco_${number}_cfg.py"
    echo ""
    ...
    outputfile="${outputdir}data_Run2015B_ZeroBias1_Prompt_v2_251721_HFRereco_${number}.root"
    ...
    echo        "),lumisToProcess = cms.untracked.VLuminosityBlockRange("\'251721:90-251721:max\'"))" >> $pyfile
    echo "" >> $pyfile
    ...
    echo "                                  data_type = cms.string("\'data-HFRereco-38T\'")," >> $pyfile 
    echo "" >> $pyfile
