...
inputdataset="input_ZeroBias_ZB1_Run2015B_PromptReco_251721.txt"
...
do
    ...
    pyfile="ZeroBias_ZB1_Run2015B_PromptReco-v1_251721_38T_${number}_cfg.py"
    echo ""
    ...
    outputfile="${outputdir}data_Run2015B_ZeroBias1_PromptReco-v1_251721_${number}.root"
    ...
    echo "                                  data_type = cms.string("\'data-PromptReco-38T\'")," >> $pyfile 
    echo "" >> $pyfile
