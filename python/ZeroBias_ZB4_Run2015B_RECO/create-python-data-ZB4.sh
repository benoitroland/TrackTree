...
inputdataset="input_ZeroBias_ZB4_Run2015B_RECO.txt"
...
do
    ...
    pyfile="ZeroBias_ZB4_Run2015B_RECO_16Oct2015_v1_251721_38T_${number}_cfg.py"
    echo ""
    ...
    outputfile="${outputdir}data_Run2015B_ZeroBias4_RECO_16Oct2015_v1_251721_${number}.root"
