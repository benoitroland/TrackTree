...
MC="PYTHIA8_CUETP8M1_38T_PU1p3"
MCTYPE="PYTHIA8-CUETP8M1-38T-PU1p3"
...
do
    ...
    aaa+="/store/mc/RunIISpring15DR74/MinBias_TuneCUETP8M1_13TeV-pythia8/GEN-SIM-RECODEBUG/"
    outputfile="${outputdir}${MCTYPE}_${number}.root"
